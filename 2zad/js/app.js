const calculateShipping = () => {
    ...
    const recipientMiddleName = document.getElementById/* volod */("recipientMiddleName").value;
    ...
    "<p> <strong> Получатель: </strong> " + recipientLastName + " " /* volod */+ recipientFirstName + " " + recipientMiddleName + "</p>" +
